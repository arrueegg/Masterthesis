    ...
    for epoch in range(1, epochs + 1):
        ...
        for i, batch in enumerate(dataloader):
            ...
            if not is_labeled.all():
                ...
                consistency_loss = consistency_criterion(optical_logits, sar_probs)
            ...
            print(supervised_loss.requires_grad)
            print(consistency_loss.requires_grad)
            ...
            """print(net.optical_stream.inc.conv.conv[1].weight.grad)
            print(loss)
            quit()"""
            ...
            if global_step % cfg.LOG_FREQ == 0 and not cfg.DEBUG:
                ...
                #evaluation.model_testing(net, cfg, device, global_step, epoch_float)  # testing #############################
